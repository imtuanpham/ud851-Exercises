...
public class ReminderTasks {
    ...
    public static void executeTask(Context context, String action) {
        if (ACTION_INCREMENT_WATER_COUNT.equals(action)) {
            ...
            issueChargingReminderNotification(context);
        }
    }
    ...
    // TODO COMPLETED (2) Create an additional task for issuing a charging reminder notification.
    ...
    private static void issueChargingReminderNotification(Context context) {
