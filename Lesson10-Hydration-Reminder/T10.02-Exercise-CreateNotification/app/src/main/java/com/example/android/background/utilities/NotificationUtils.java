...
public class NotificationUtils {
    ...
    public static final int HYDRATION_PENDING_INTENT_ID = 101;
    ...
    void remindUserBecauseCharging(Context context) {
    ...
    public PendingIntent contentIntent(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, HYDRATION_PENDING_INTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
